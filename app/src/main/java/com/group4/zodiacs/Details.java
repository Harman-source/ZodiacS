...
public class Details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Objects.equals(sign, "aries")){
            ...
            xOutput.setMovementMethod(new ScrollingMovementMethod());
            ImageButton ib = (ImageButton) findViewById(R.id.pic);
            ib.setBackgroundResource(R.drawable.leo);
        }
            ...
            xOutput.setMovementMethod(new ScrollingMovementMethod());
            ImageButton ib = (ImageButton) findViewById(R.id.pic);
            ib.setBackgroundResource(R.drawable.virgo);
        }
            ...
            xOutput.setMovementMethod(new ScrollingMovementMethod());
            ImageButton ib = (ImageButton) findViewById(R.id.pic);
            ib.setBackgroundResource(R.drawable.libra);
        }
            ...
            xOutput.setMovementMethod(new ScrollingMovementMethod());
            ImageButton ib = (ImageButton) findViewById(R.id.pic);
            ib.setBackgroundResource(R.drawable.scorpio);
        }
            ...
            xOutput.setMovementMethod(new ScrollingMovementMethod());
            ImageButton ib = (ImageButton) findViewById(R.id.pic);
            ib.setBackgroundResource(R.drawable.sagittarius);
        }
            ...
            xOutput.setMovementMethod(new ScrollingMovementMethod());
            ImageButton ib = (ImageButton) findViewById(R.id.pic);
            ib.setBackgroundResource(R.drawable.capricorn);
        }
            ...
            xOutput.setMovementMethod(new ScrollingMovementMethod());
            ImageButton ib = (ImageButton) findViewById(R.id.pic);
            ib.setBackgroundResource(R.drawable.aquarius);
        }
            ...
            xOutput.setMovementMethod(new ScrollingMovementMethod());
            ImageButton ib = (ImageButton) findViewById(R.id.pic);
            ib.setBackgroundResource(R.drawable.pisces);
        }
